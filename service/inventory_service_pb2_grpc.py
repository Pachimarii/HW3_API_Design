...
class InventoryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateBook = channel.unary_unary(
                '/libinventory.InventoryService/CreateBook',
        ...
        self.GetBook = channel.unary_unary(
                '/libinventory.InventoryService/GetBook',
...
def add_InventoryServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'libinventory.InventoryService', rpc_method_handlers)
...
class InventoryService(object):
    ...
    def CreateBook(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/libinventory.InventoryService/CreateBook',
    ...
    def GetBook(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/libinventory.InventoryService/GetBook',
